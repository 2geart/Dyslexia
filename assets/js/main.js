...
(function ($) {
    ...
    $('button.order-book').click(function () {
        let t = ($('#x_contact_massage').text() ? '\n' : '') + 'Заказать книгу: автор - ' + $(this).prev().text() + ', \"' + $(this).prev().prev().text() + '\"';
        $('#x_contact_massage').text($('#x_contact_massage').text() + t);
        setTimeout(function () {
            $('html,body').animate({
